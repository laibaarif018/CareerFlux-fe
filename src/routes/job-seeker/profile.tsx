...
export default function Profile() {
  ...
  useEffect(() => {
    if (data?.payload?.user) {
      ...
      setValue('phone', jobSeeker?.phoneNumber ?? '')
      setValue('location', jobSeeker?.location ?? '')
      setValue('experienceLevel', jobSeeker?.experienceLevel ?? 'mid')
      setValue('roles', jobSeeker?.preferredRoles ?? [])
      setValue('industries', jobSeeker?.preferredIndustries ?? [])
      setValue('locations', jobSeeker?.preferredLocations ?? [])
      setValue('salary', jobSeeker?.minimumSalaryExpected ?? 0)
    }
  }, [data, setValue])
                  ...
                  >
                    {watchedIndustries.map((ind) => (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={() => handleArrayRemove('industries', ind as any)}
                          className="hover:bg-[#3EC3BC]/30 dark:hover:bg-[#0E7C8C]/50 rounded-full p-0.5 transition-colors"
                  ...
                  >
                    {watchedLocations.map((loc) => (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={() => handleArrayRemove('locations', loc as any)}
                          className="hover:bg-[#3EC3BC]/30 dark:hover:bg-[#0E7C8C]/50 rounded-full p-0.5 transition-colors"
